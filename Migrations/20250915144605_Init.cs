        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StockInWarehouse = table.Column<int>(type: "int", nullable: false),
                    StockInStore = table.Column<int>(type: "int", nullable: false),
                    WarehouseCapacity = table.Column<int>(type: "int", nullable: false),
